...
$$\chi_A\ast\chi_B(x)=\int_{\mathbb{R}^n} \chi_A(y)\cdot\chi_B(x-y)\mathrm dy=\int_A\chi_B(x-y)\mathrm dy=\int_{x-A}\chi_B(y)\mathrm dy=\abs{B\cap(x-A)}$$
...
$$\int_{\mathbb{R}^n} \chi_A\ast\chi_B(x) \mathrm dx= \iint_{\mathbb{R}^n\times\mathbb{R}^n} \chi_A(y)\cdot\chi_B(x-y)\mathrm dy \mathrm dx =\abs{A}\cdot\abs{B} > 0$$
