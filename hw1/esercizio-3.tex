...
\begin{align*}
  L(\Gamma_f, \mathcal{P})
  &= \sum_{k=1}^{N} \sqrt{ (a_k - a_{k-1})^2 + (f(a_k) - f(a_{k-1}))^2 } \geq \\
  &= \sum_{k=1}^{N} \left\lvert f(a_k) - f(a_{k-1}) \right\rvert = V(f, \mathcal{P})
\end{align*}
...
\begin{align*}
  L(\Gamma_f, \mathcal{P})
  &= \sum_{k=1}^{N} \sqrt{ (a_k - a_{k-1})^2 + (f(a_k) - f(a_{k-1}))^2 } \leq \\
  % &= \sum_{k=1}^{N} \left\lvert f(a_k) - f(a_{k-1}) \right\rvert = V(f,
  %   \mathcal{P}) \leq \\
  &\le \sum_{k=1}^{N} \left\{ \left\lvert a_k -a_{k-1} \right\rvert
    + \left\lvert f(a_k) - f(a_{k-1}) \right\rvert \right\} = b - a +
  V(f, \mathcal{P})
\end{align*}
